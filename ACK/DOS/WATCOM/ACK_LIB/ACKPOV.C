...
//=============================================================================
// Internal function called by AckMovePOV().
// Checks the passed X and Y coordinates against the object coordinates.
//=============================================================================
...
//=============================================================================
short AckCheckAngle(short Angle,short Amount)
{
    short   x1,y1,NewAngle;
    short   xp,yp;
    UINT    mCodeX,mCodeY;
    short   MapPosn,Quad,mpx,mpy;
...
mCodeX = xGridGlobal[mpx];
mCodeY = yGridGlobal[mpy];

if (mCodeX & WALL_TYPE_PASS)
    mCodeX = 0;

if (mCodeY & WALL_TYPE_PASS)
    mCodeY = 0;
...
//=============================================================================
// Internal function called by AckMovePOV() and AckMoveObjectPOV().
// Checks for a hit with a wall within a certain distance.
//=============================================================================
...
// TEST If a floating wall, allow the POV to pass under it --------------------
...
//=============================================================================
// This function has been trimmed back in functionality. It now only cycles
// through the various animations of an object and does not actually move
